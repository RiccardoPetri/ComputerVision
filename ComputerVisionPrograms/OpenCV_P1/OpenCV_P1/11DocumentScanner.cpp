...
//		//Crop - Step 4
//		//int cropVal = 5;
//		//Rect roi(cropVal, cropVal, w - (2 * cropVal), h - (2 * cropVal)); //i want to crop=ritagliare 5 pixel from each side
//		//imgCrop = imgWarp(roi);
//
//		imshow("Image", img); //imshow("Image", imgOriginal);
//
//		//imshow("Image Dilation", imgThre);
//		imshow("Image Warp", imgWarp);
//		//imshow("Image Crop", imgCrop);
